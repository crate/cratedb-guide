...
```shell
docker compose run --rm --no-TTY ctk-ingest ctk load "postgresql://postgres:postgres@postgresql:5432/test?table=public.demo" "crate://crate:crate@cratedb:4200/doc/postgresql_demo"
```
